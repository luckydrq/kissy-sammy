KISSY.add('sammy/application',function(S, Sammy, Node){
  ...
  var _decode = function( str ) { return decodeURIComponent((str || '').replace(/\+/g, ' ')) }
  var _routeWrapper = function(verb) {
    return function() {
  ...
  S.extend(SammyApplication, {
    ...
    bindToAllEvents: function(callback) {
      ...
      S.each(this.listeners.keys(true), function(name, i) {
        if (!S.inArray(name, app.APP_EVENTS)) {
    ...
    contextMatchesOptions: function(context, match_options, positive) {
      ...
      if (S.isArray(options.path)){
        ...
        var matched = S.inArray(true, results)
